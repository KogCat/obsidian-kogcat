...
type V3LLMProvider = { type?: string; id?: string; [key: string]: unknown }
type V3ChatModel = {
  providerType?: string
  providerId?: string
  id?: string
...
export const NEW_DEFAULT_PROVIDERS: V3LLMProvider[] = [
  {
    type: 'lm-studio',
...
export const NEW_DEFAULT_CHAT_MODELS: V3ChatModel[] = [
  {

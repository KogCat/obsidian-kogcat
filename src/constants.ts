...
export const CHAT_VIEW_TYPE = 'cc-chat-view'
export const APPLY_VIEW_TYPE = 'cc-apply-view'
export const REVIEW_VIEW_TYPE = 'kogcat-review-view'
export const KOGCAT_ICON_ID = 'kog-cat'
...
// Injected at build time (esbuild define) from GEMINI_OAUTH_CLIENT_SECRET env /
// secrets.local.json — see DEVELOPMENT.md. Kept out of source so secret scanners
// never trip; empty in any build that does not supply it.
...
export const DEFAULT_APPLY_MODEL_ID = 'gpt-5.5'

export const RECOMMENDED_MODELS_FOR_CHAT = ['claude-sonnet-4.6', 'gpt-5.5']
export const RECOMMENDED_MODELS_FOR_APPLY = ['gpt-5.5']
...
export const VISIBLE_API_PROVIDER_TYPES = [
  'anthropic',
  'openai',
  'gemini',
  'deepseek',
...
export type VisibleApiProviderType = (typeof VISIBLE_API_PROVIDER_TYPES)[number]

export const isVisibleApiProviderType = (
  type: LLMProviderType,
): type is VisibleApiProviderType =>
  VISIBLE_API_PROVIDER_TYPES.includes(type as VisibleApiProviderType)
...
export const DEFAULT_CHAT_MODELS: readonly ChatModel[] = [
  ...
  },
  {
    ...
    providerId: PROVIDER_TYPES_INFO.openrouter.defaultProviderId,
    id: 'openrouter/auto',
...
export const DEEPSEEK_PRICES: Record<string, ModelPricing> = {
  // Model version: DeepSeek-V4
  'deepseek-v4-flash': { input: 0.14, output: 0.28 },
  'deepseek-v4-pro': { input: 1.74, output: 3.48 },
  // Legacy names scheduled for deprecation by DeepSeek.

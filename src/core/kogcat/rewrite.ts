...
- ${answerModeConstraints(answerMode)}
...
- If references are useful, put them only at the end under a compact "参考依据" / "References" section.
...
function answerModeConstraints(answerMode: KogCatAnswerMode): string {
  ...
  return [
    ...
    'Prefer one short "KogCat 提醒" section plus one concise takeaway when the language is Chinese; keep it similarly compact in other languages.',

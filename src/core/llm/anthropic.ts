  ...
  async generateResponse(
    ...
    try {
      ...
      if (error instanceof Anthropic.AuthenticationError) {
        // CORS issue affecting new individual Anthropic accounts.
        // See https://github.com/glowingjade/obsidian-smart-composer/issues/286
        // Workaround: user creates an organization in their Anthropic account.
        if (

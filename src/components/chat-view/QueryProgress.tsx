...
export default function QueryProgress({
  ...
  switch (state.type) {
    ...
    case 'reading-mentionables':
      return (
        <div className="cc-query-progress">
          <p>
    ...
    case 'indexing':
      return (
        <div className="cc-query-progress">
          ...
          <p className="cc-query-progress-detail">{`${state.indexProgress.completedChunks}/${state.indexProgress.totalChunks} chunks indexed`}</p>
          {state.indexProgress.waitingForRateLimit && (
            <p className="cc-query-progress-detail">

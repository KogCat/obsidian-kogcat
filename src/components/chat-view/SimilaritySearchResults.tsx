...
function SimiliartySearchItem({
  ...
  return (
    <div onClick={handleClick} className="cc-similarity-search-item">
      <div className="cc-similarity-search-item__similarity">
        {chunk.similarity.toFixed(3)}
      </div>
      <div className="cc-similarity-search-item__path">
        {path.basename(chunk.path)}
      </div>
      <div className="cc-similarity-search-item__line-numbers">
...
export default function SimilaritySearchResults({
  ...
  return (
    <div className="cc-similarity-search-results">
      <div
        onClick={() => {
          setIsOpen(!isOpen)
        }}
        className="cc-similarity-search-results__trigger"
      >

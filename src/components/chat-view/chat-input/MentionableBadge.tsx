...
function BadgeBase({
  ...
  return (
    <div
      className={`cc-chat-user-input-file-badge ${isFocused ? 'cc-chat-user-input-file-badge-focused' : ''}`}
      onClick={onClick}
    >
      {children}
      <div
        className="cc-chat-user-input-file-badge-delete"
        onClick={(evt) => {
          evt.stopPropagation()
          onDelete()
        }}
...
function FileBadge({
  ...
  return (
    <BadgeBase onDelete={onDelete} onClick={onClick} isFocused={isFocused}>
      <div className="cc-chat-user-input-file-badge-name">
        {Icon && (
          <Icon
            size={12}
            className="cc-chat-user-input-file-badge-name-icon"
          />
        )}
...
function CurrentFileBadge({
  ...
  return mentionable.file ? (
    <BadgeBase onDelete={onDelete} onClick={onClick} isFocused={isFocused}>
      ...
      <div
        className={clsx(
          'cc-chat-user-input-file-badge-name-suffix',
          !settings.chatOptions.includeCurrentFileContent &&
            'cc-excluded-content',
        )}
      >
      ...
      <div
        className="cc-chat-user-input-file-badge-eye"
...
function BlockBadge({
  ...
  return (
    <BadgeBase onDelete={onDelete} onClick={onClick} isFocused={isFocused}>
      ...
      <div className="cc-chat-user-input-file-badge-name-suffix">

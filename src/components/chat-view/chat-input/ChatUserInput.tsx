...
const ChatUserInput = forwardRef<ChatUserInputRef, ChatUserInputProps>(
  (
    ...
    const [displayedMentionableKey, setDisplayedMentionableKey] = useState<
      string | null
    >(addedBlockKey ?? null)
    const visibleMentionables = useMemo(
      () => mentionables.filter((m) => m.type !== 'current-file'),
      [mentionables],
    )
    ...
    return (
      <div
        className={`cc-chat-user-input-container cc-chat-user-input-container--${variant}`}
        ref={containerRef}
      >
        {visibleMentionables.length > 0 && (
          <div className="cc-chat-user-input-files">
            {visibleMentionables.map((m) => (
              <MentionableBadge
        ...
        <MentionableContentPreview
          ...
          mentionables={visibleMentionables}
        />
        ...
        <div className="cc-chat-user-input-controls">
          <div className="cc-chat-user-input-controls__model-select-container">
            <ModelSelect />
          </div>
          <div className="cc-chat-user-input-controls__buttons">
...
function MentionableContentPreview({
  ...
  return displayFileContent ? (
    <div className="cc-chat-user-input-file-content-preview">

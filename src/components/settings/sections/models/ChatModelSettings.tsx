    ...
    SettingsComponent: (props: SettingsComponentProps) => {
      ...
      return (
        <>
          ...
          <ObsidianSetting>
            <ObsidianButton text={t('modal:addProvider.save')} onClick={handleSubmit} cta />
        ...
        <>
          ...
          >
            <ObsidianDropdown
              value={reasoningEffort}
              options={{
                '': t('settings:modelOptions.openaiPlan.reasoningEffort.notSet'),
                none: 'none',
                minimal: 'minimal',
                low: 'low',
                medium: 'medium',
          ...
          >
            <ObsidianDropdown
              ...
              options={{
                '': t('settings:modelOptions.openaiPlan.reasoningSummary.notSet'),
                auto: 'auto',
                concise: 'concise',
                detailed: 'detailed',
              }}
